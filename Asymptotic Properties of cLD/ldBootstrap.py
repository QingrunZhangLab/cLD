...
#This code is to use bootstrap method to calculate the LD.


openfile = open(r'/PATH/psd0kchr2eur.txt','r') #SNP file
genesample = open(r'/PATH/genesample.txt') #gene samples
outfile = '/PATH/ldBootstrapResult.txt' # Output
chr = '2'
thre = 0.005     #threshold of rare variant#
indsamplesize = 250 #Sample size of each iteration
epoch = 250 
...
ldvarlist = []
genesnp = [[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]]*100
snpnum = [0]*100 #this value equals the number of genes
#######################start the iteration################
t = 0
